...
CFLAGS := $(CFLAGS) -flto --target=wasm32 -I $(PLATFORM_INCLUDE_DIR)/web -I $(BUILD_DIR)
...
$(BUILD_DIR)/%: $(RESOURCES_DIR)/%
	...
	$(if $(filter y, $(WEB_RESOURCES_MINIFY)), $(call minify, $@ -o $@))
$(CONFIG_FILE):
	@ $(call mkdir, $(@D))
	@ $(call common_config)
$(PLATFORM_INSTALL):
	...
	@ $(if $(filter y, $(WEB_RESOURCES_MINIFY)), $(call install, minify, install_minify))
$(PLATFORM_UNINSTALL):
	@ $(call uninstall, clang, uninstall_clang)
	@ $(call uninstall_wasm32, uninstall_llvm)
	@ $(call uninstall, $(WASM_LD), uninstall_wasm_ld)
	@ $(if $(filter y, $(WEB_RESOURCES_MINIFY)), $(call uninstall, minify, uninstall_minify))
